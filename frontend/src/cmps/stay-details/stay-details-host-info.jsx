            ...
            <>
              <div className="flex row mar-b24">
                ...
                <div className="host-content">
                  ...
                  <div className="fs14 dark-content">
                    {stay.host.fullname} has received 5-star ratings from 95% of
                    recent guests.
                  </div>
                </div>
              </div>
          ...
          <div className="amenities-list">
            ...
            <div>
              <img
                className="amenities-icons"
                src={
                  require("../../assets/img/icons/mountain-view.svg").default
                }
                alt=""
              />
            ...
            <div>
              <img
                className="amenities-icons"
                src={
                  require("../../assets/img/icons/private-entrance.svg").default
                }
                alt=""
              />
