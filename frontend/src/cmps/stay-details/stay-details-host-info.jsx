    ...
    <section className="stay-details-host-info">
      <div className="basic-info">
        <div className="host-info">
          <div className="fs22 fw600 mar-b8">{stay.name} hosted by {stay.host.fullname}</div>
          <div> 2 guests · 1 bedroom · 1 bed · Half-bath</div>
        </div>
        <div className="avatar-lg"><img src="../../assets/img/other/DOGE.jpg" alt="avatar-lg" /></div>
      </div>
      <div className="host">
        <div className="host-content">
          <div className="fw600 mar-b4">{stay.host.fullname} is a Superhost</div>
      ...
      <div className="bedding">
        ...
        <div className="icon mar-b16"><MdOutlineKingBed/></div>
